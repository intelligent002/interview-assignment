...
export const RATE_LIMIT_ADJUST_COEFFICIENT = process.env.RATE_LIMIT_ADJUST_COEFFICIENT as string || 'coefficient'
export const RATE_LIMIT_ADJUST_EVERY_SECONDS = parseInt(process.env.RATE_LIMIT_ADJUST_EVERY_SECONDS as string) || 10;
export const RATE_LIMIT_ADJUST_MULTIPLIER = parseInt(process.env.RATE_LIMIT_ADJUST_MULTIPLIER as string) || 2;
export const RATE_LIMIT_ADJUST_TREND = process.env.RATE_LIMIT_ADJUST_TREND || 'trend';
...
export const RATE_LIMIT_LEADER_CADENCE = parseInt(process.env.RATE_LIMIT_LEADER_CADENCE as string) || 60_000;
