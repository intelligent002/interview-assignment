...
export const KAFKA_TOPIC_CITIES_PARTITIONS = parseInt(process.env.KAFKA_TOPIC_CITIES_PARTITIONS || '3');
...
export const KAFKA_TOPIC_STREETS_PARTITIONS = parseInt(process.env.KAFKA_TOPIC_STREETS_PARTITIONS || '3');
